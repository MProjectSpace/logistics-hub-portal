...
# ETB : DATE
#
# Setiap vessel berikutnya menjadi batas record baru.
# ============================================================
...
def parse_schedule(text):
    ...
    # --------------------------------------------------------
    # Parse setiap record berdasarkan vessel berikutnya
    # --------------------------------------------------------
    ...
    for position_index, start in enumerate(
        ...
        # Vessel berikutnya menjadi batas record
        if position_index + 1 < len(
            vessel_positions
        ):
